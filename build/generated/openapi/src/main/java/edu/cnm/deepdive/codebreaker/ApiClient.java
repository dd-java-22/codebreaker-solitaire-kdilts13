...
import edu.cnm.deepdive.codebreaker.auth.HttpBasicAuth;
import edu.cnm.deepdive.codebreaker.auth.HttpBearerAuth;
import edu.cnm.deepdive.codebreaker.auth.ApiKeyAuth;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "https://ddc-java.services/codebreaker-solitaire";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
