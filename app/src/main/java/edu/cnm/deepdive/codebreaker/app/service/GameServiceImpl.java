...
public class GameServiceImpl implements GameService {
  ...
  @Inject
  GameServiceImpl(CodebreakerService service, GameSummaryRepository gameSummaryRepository) {
    this.service = service;
    this.repository = gameSummaryRepository;
  }

  @Override
  public CompletableFuture<Game> startGame(Game game) {
    return service.startGame(game)
